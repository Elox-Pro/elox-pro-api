...
export class JwtConfig {
    ...
    public readonly ACCESS_TOKEN_TTL = parseInt(process.env.JWT_ACCESS_TOKEN_TTL) || 1500;

    // Define how long the refresh token should be valid for (in seconds)
    public readonly REFRESH_TOKEN_TTL = parseInt(process.env.JWT_REFRESH_TOKEN_TTL) || 3000;
    ...
    public readonly BUFFER_TIME = parseInt(process.env.JWT_BUFFER_TIME) || 1200;
}